                        ...
                        if(isset($_POST['submitLines'])){
                            ...
                            for( $i = 0; $i < $count; $i++) {
                                ...
                                if(intval($row[1]) >= intval($quantity)){
                                    ...
                                    $sqlLines[] = "INSERT INTO `compx`.`lines477` (lineNo477, purchaseOrder477_poNo477, quantityOnOrder477, purchasePrice477, parts477_partNo477) VALUES ($lineNumber, $poNo, $quantity, $row[0], $part);";
                            ...
                            if($failure){
                                ...
                                $time = date('Y-m-d');
                                $sql = "INSERT INTO `compx`.`purchaseOrder477` (`poNo477`, `datePO477`, `status477`, `clientID477`) VALUES ($poNo, '$time', 'incomplete', $clientID);";
                                $conn->query($sql);
